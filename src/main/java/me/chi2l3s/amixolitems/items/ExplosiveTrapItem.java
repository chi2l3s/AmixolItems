...
public class ExplosiveTrapItem {

    public final AmixolItems plugin;

    public ExplosiveTrapItem(AmixolItems plugin) {
        this.plugin = plugin;
    }

    public ItemStack itemStack(){

        String materialString = plugin.getConfig().getString("explosivetrapitem.material");
        String name = plugin.getConfig().getString(ColorUtil.message(ChatColor.translateAlternateColorCodes('&',"explosivetrapitem.display-name")));
        List<String> lore = plugin.getConfig().getStringList("explosivetrapitem.lore");
