...
public class StunItem {

    private final AmixolItems plugin;

    public StunItem(AmixolItems plugin) {
        this.plugin = plugin;
    }

    public ItemStack itemStack(){
        String materialString = plugin.getConfig().getString("stunitem.material");
        String name = plugin.getConfig().getString(ColorUtil.message(ChatColor.translateAlternateColorCodes('&',"stunitem.display-name")));
        List<String> lore = plugin.getConfig().getStringList("stunitem.lore");
