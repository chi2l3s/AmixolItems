...
public class PortHoleItem {

    private final AmixolItems plugin;

    public PortHoleItem(AmixolItems plugin) {
        this.plugin = plugin;
    }

    public ItemStack itemStack(){
        String materialString = plugin.getConfig().getString("portHoleItem.material");
        String name = plugin.getConfig().getString(ColorUtil.message(ChatColor.translateAlternateColorCodes('&',"portHoleItem.display-name")));
        List<String> lore = plugin.getConfig().getStringList("portHoleItem.lore");
