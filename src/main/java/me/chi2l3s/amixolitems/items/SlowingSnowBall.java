...
public class SlowingSnowBall {

    private final AmixolItems plugin;

    public SlowingSnowBall(AmixolItems plugin) {
        this.plugin = plugin;
    }
    public ItemStack itemStack(){
        String materialString = plugin.getConfig().getString("slowingsnowball.material");
        String name = plugin.getConfig().getString(ColorUtil.message(ChatColor.translateAlternateColorCodes('&',"slowingsnowball.display-name")));
        List<String> lore = plugin.getConfig().getStringList("slowingsnowball.lore");
