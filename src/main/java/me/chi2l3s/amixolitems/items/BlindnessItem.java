...
public class BlindnessItem {
    ...
    public BlindnessItem(AmixolItems plugin) {
        this.plugin = plugin;
    }

    public ItemStack itemStack(){
        String materialString = plugin.getConfig().getString("blindnessItem.material");
        String name = plugin.getConfig().getString(ColorUtil.message(ChatColor.translateAlternateColorCodes('&',"blindnessItem.display-name")));
        List<String> lore = plugin.getConfig().getStringList("blindnessItem.lore");
